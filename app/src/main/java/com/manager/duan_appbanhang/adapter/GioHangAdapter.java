...
import com.manager.duan_appbanhang.Interface.IImageClickListener;
import com.manager.duan_appbanhang.R;
import com.manager.duan_appbanhang.mode.EventBus.TinhTongEvent;
...
//        Glide.with(context).load(gioHang.getHinhsp()).into(holder.item_giohang_image);
        ...
        if(gioHang.getHinhsp().contains("http")){
            ...
            String hinh = Utils.BASE_URL+"imges/"+gioHang.getHinhsp();
